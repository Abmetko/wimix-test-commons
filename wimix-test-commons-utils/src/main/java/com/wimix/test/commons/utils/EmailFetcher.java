package com.wimix.test.commons.utils;

import com.sun.mail.util.MailSSLSocketFactory;
import com.wimix.test.commons.config.ZegoalConfig;
...
public class EmailFetcher {
    ...
    private static String extractRegistrationId() throws MessagingException, EmailNotReceivedException, GeneralSecurityException, IOException {
        ...
        String username = ZegoalConfig.getEmail();
        String password = ZegoalConfig.getAppPassword();
        String messageBody = fetch(host, mailStoreType, username, password);
        return messageBody
                .replaceAll("\n", "")
                .split(ZegoalConfig.getBaseUrl() + "signup/")[1]
